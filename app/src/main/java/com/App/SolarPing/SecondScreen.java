...
public class SecondScreen extends AppCompatActivity {
    ...
    private void uploader(){
        ...
        FeedBack feedBack = new FeedBack(title,contents,formatDate);
        database.child("feedback").child(title).setValue(feedBack);
...
class FeedBack{
    ...
    public FeedBack(String title,String contents,String formateDate){
        this.title = title;
